        ...
        <table width="80%" align="center">
            ...
            <asp:Label ID="lpCaseID" runat="server" Text=""></asp:Label>
                                                    ...
                                                    <tr>
                                                        <td class="auto-style3"><span>
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            <asp:Button ID="Button7" runat="server" class="button button2" Text="Save Changes" Width="172px" />
                                                            </span></td>
                                ...
                                <tr>
                                    <td>
                                        <h3>
                                                ...
                                                <h3 class="auto-style4">Reallocate Case</h3>
...
<%--                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="iiemptxt" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>--%>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:DropDownList ID="iiDropDownList" runat="server" DataSourceID="EntityDataSource7" DataTextField="Case_ID" DataValueField="Case_ID"></asp:DropDownList>
...
<%--                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="icasetxt" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>--%>
                                                            ...
                                                            <asp:DropDownList ID="iDropDownList" runat="server" DataSourceID="EntityDataSource7" DataTextField="Case_ID" DataValueField="Case_ID">
                                                            </asp:DropDownList>
...
<%--                                                            <asp:RequiredFieldValidator runat="server" ErrorMessage="*" ControlToValidate="trCasetxt" ForeColor="Red"></asp:RequiredFieldValidator>--%>
                                                            ...
                                                            <asp:DropDownList ID="trDropDownList" runat="server" DataSourceID="EntityDataSource7" DataTextField="Case_ID" DataValueField="Case_ID">
                                                            </asp:DropDownList>
